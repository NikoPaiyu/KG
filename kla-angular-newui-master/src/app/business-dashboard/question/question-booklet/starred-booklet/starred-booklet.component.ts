...
@Component({
  selector: "app-starred-booklet",
  templateUrl: "./starred-booklet.component.html",
  styleUrls: ["./starred-booklet.component.scss"],
})
export class StarredBookletComponent implements OnInit {
  questionDates: any = [];
