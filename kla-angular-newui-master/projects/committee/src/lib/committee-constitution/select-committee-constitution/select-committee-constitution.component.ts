...
@Component({
  selector: "committee-select-committee-constitution",
  templateUrl: "./select-committee-constitution.component.html",
  styleUrls: ["./select-committee-constitution.component.css"],
})
export class SelectCommitteeConstitutionComponent implements OnInit {
