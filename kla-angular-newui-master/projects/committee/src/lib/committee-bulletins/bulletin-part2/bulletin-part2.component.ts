...
export class BulletinPart2Component implements OnInit {
  ...
  listOfAllData: any;
  filtrParams: any = {};
  constructor(private bullettin: CommitteeBulletinService,
    public commmon: CommitteeBullettincommonService,
