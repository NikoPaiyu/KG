...
import { createBillModel } from '../model/bill-content.model';
@Injectable({
  providedIn: 'root'
})
export class BlockSuggestService {
  ...
  isDeletAllowed(code) {
    ...
    ,'MEMORANDUM_REGARDING_DELEGATED_LEGISLATION','FINANCIAL_MEMORANDUM','STATEMENT_OF_OBJECTS_AND_REASONS'];
    return restrictedBlocks.indexOf(code) === -1;
  }
}
