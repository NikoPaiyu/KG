...
@Component({
  selector: 'tables-view-time-allocation',
  templateUrl: './view-time-allocation.component.html',
  styleUrls: ['./view-time-allocation.component.css']
})
export class ViewTimeAllocationComponent implements OnInit {
  ...
  patchFormValues() {
    this.TimeallocationForm.patchValue({
      ...
      timeAllocatedDate: this.timeAllocationData.timeAllocatedDate,
      totalTime:this.timeAllocationData.totalTime,
      moverTime: this.timeAllocationData.moverTime,
      ministersReplyTime: this.timeAllocationData.ministersReplyTime,
      businessId: this.timeAllocationData.businessDto.id
    });
