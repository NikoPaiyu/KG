...
@Component({
  selector: 'tables-resume-prepare',
  templateUrl: './resume-prepare.component.html',
  styleUrls: ['./resume-prepare.component.css']
})
export class ResumePrepareComponent implements OnInit {
