...
export class ResumeListComponent implements OnInit {
        ...
        switch (element.key) {
          case "date":
            this.allTableDiary.forEach((value) => {
              value.date = formatDate(value.date, 'dd-MM-yyyy', 'en');
  ...
  getRbsPermissionsinList() {
    ...
    if (this.commonService.doIHaveAnAccess('CREATE_RESUME', 'CREATE')) {
      this.permission.createResume = true;
    }
  }
