...
export class ListsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //     this.ordIntroductionList =this.tempordIntroductionList= res;
  ...
  getGeneralAmendments() {
    ...
    this.billService.getdataList(body).subscribe((Res) => {
  ...
  view(listId) {
    this.billService.getClauseListByListId(listId).subscribe((res) => {
      if (res) {
        this.list = res;
      }
    });
