...
@Component({
  selector: 'lib-clause-by-clause-all-amendments',
  templateUrl: './clause-by-clause-all-amendments.component.html',
  styleUrls: ['./clause-by-clause-all-amendments.component.css']
})
export class ClauseByClauseAllAmendmentsComponent implements OnInit {
  ...
  view_List(billId) {
    this.router.navigate([
      'business-dashboard/bill/clause-by-clause-notices-for-list',
      billId
    ]);
  }
  ...
  view_Bill(billId) {
    this.router.navigate([
      'business-dashboard/bill/create-clause-by-clause',
      billId
    ]);
  }
  // getAssistantList() {
