...
@Component({
  selector: 'correspondence-template-create',
...
export class TemplateCreateComponent implements OnInit {
  ...
  getAllBusiness() {
    this.correspondenceService.getAllBusiness().subscribe((res) => {
  ...
  getAllType() {
    ...
    if(this.radioValue == 'PPO'){
      this.templateForm
          .get('type')
          .setValue('PPO');
    }else{
    this.correspondenceService.getAllCode(this.radioValue).subscribe((res) => {
      this.TypesList = res;
    });
  }
  }
  ...
  getAllWorkflow(type) {
    if (type && this.radioValue === 'SECTION') {
      this.correspondenceService.getAllWorkflow(type).subscribe((res) => {
  ...
  getTemplateInputList() {
    this.correspondenceService.getTemplateInputTypes().subscribe((res) => {
