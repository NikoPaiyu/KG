...
@Component({
  selector: 'lib-resolution-clause-by-clause-all-amendments',
  templateUrl: './clause-by-clause-all-amendments.component.html',
  styleUrls: ['./clause-by-clause-all-amendments.component.css']
})
export class ResolutionClauseByClauseAllAmendmentsComponent implements OnInit {
  ...
  view_List(billId) {
    this.router.navigate([
      'business-dashboard/pmbr/clause-by-clause-notices-for-list',
      billId
    ]);
  }
