export const createBillModel = {
  enactingFormula: [
    { title: "Chapter", code: "CHAPTER", id: 20, color: "purple" },
    { title: "Clause", code: "CLAUSE", id: 3, color: "volcano" },
  ],
  marginalHeading: [
    { title: "Clause Details", code: "DETAILS", id: 9, color: "orange" },
    { title: "Clause", code: "CLAUSE", id: 3, color: "volcano" },
  ...
  subClause: [
    { title: "Sub Clause Details", code: "DETAILS", id: 9, color: "orange" },
    { title: "Sub Clause", code: "SUB_CLAUSE", id: 4, color: "blue" },
    { title: "Clause", code: "CLAUSE", id: 3, color: "volcano" },
    { title: "Item", code: "ITEM", id: 5, color: "magenta" },
    { title: "Table", code: "TABLE", id: 27, color: "red" },
  ...
  item: [
    { title: "Item Details", code: "DETAILS", id: 9, color: "orange" },
    { title: "Item", code: "ITEM", id: 5, color: "magenta" },
  ...
  subItem: [
    { title: "Sub Item Details", code: "DETAILS", id: 9, color: "orange" },
    { title: "Item", code: "ITEM", id: 5, color: "magenta" },
    { title: "Clause", code: "CLAUSE", id: 3, color: "volcano" },
    { title: "Sub Clause", code: "SUB_CLAUSE", id: 4, color: "blue" },
    { title: "Proviso", code: "PROVISO", id: 11, color: "cyan" },
